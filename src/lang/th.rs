...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "ช่วงเวลาการค้นหา (วินาที)"),
        ("Discovery timeout (seconds)", "เวลาหมดอายุการค้นหา (วินาที)"),
        ("Invalid value, valid range is {}-{}", "ค่าที่ไม่ถูกต้อง, ช่วงค่าที่ถูกต้องคือ {}-{}"),
