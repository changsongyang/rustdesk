...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Khoảng thời gian phát hiện (giây)"),
        ("Discovery timeout (seconds)", "Thời gian chờ phát hiện (giây)"),
        ("Invalid value, valid range is {}-{}", "Giá trị không hợp lệ, khoảng hợp lệ là {}-{}"),
