...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "கண்டுபிடிப்பு இடைவெளி (விநாடிகள்)"),
        ("Discovery timeout (seconds)", "கண்டுபிடிப்பு நேரத்தை முடிக்க (விநாடிகள்)"),
        ("Invalid value, valid range is {}-{}", "தவறான மதிப்பு, செல்லுபடியாகும் வரம்பு {}-{}"),
