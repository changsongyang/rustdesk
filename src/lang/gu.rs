...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "ડિસ્કવરી અંતરાલ (સેકન્ડ)"),
        ("Discovery timeout (seconds)", "ડિસ્કવરી ટાઇમઆઉટ (સેકન્ડ)"),
        ("Invalid value, valid range is {}-{}", "અમાન્ય મૂલ્ય, માન્ય શ્રેણી {}-{} છે"),
