...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Atklāšanas intervāls (sekundes)"),
        ("Discovery timeout (seconds)", "Atklāšanas laiks (sekundes)"),
        ("Invalid value, valid range is {}-{}", "Nederīga vērtība, derīgs diapazons {}-{}"),
