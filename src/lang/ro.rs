...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Interval de descoperire (secunde)"),
        ("Discovery timeout (seconds)", "Timp de expirare descoperire (secunde)"),
        ("Invalid value, valid range is {}-{}", "Valoare invalidă, interval valid este {}-{}"),
