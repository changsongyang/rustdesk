...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Intervalo de descoberta (segundos)"),
        ("Discovery timeout (seconds)", "Tempo limite de descoberta (segundos)"),
        ("Invalid value, valid range is {}-{}", "Valor inválido, o intervalo válido é {}-{}"),
