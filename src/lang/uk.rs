...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Інтервал пошуку (секунди)"),
        ("Discovery timeout (seconds)", "Тайм-аут пошуку (секунди)"),
        ("Invalid value, valid range is {}-{}", "Недійсне значення, допустимий діапазон {}-{}"),
