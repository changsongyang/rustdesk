...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Avastamise intervall (sekundit)"),
        ("Discovery timeout (seconds)", "Avastamise aikakatkaisu (sekundit)"),
        ("Invalid value, valid range is {}-{}", "Vale väärtus, kehtiv vahemik on {}-{}"),
