...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Enable LAN discovery", "Жергілікті желіді анықтау"),
        ("Deny LAN discovery", "Жергілікті желіді анықтауды бас тарту"),
        ("Discovery interval (seconds)", "Анықтау интервалы (секунд)"),
        ("Discovery timeout (seconds)", "Анықтау уақыты (секунд)"),
        ("Invalid value, valid range is {}-{}", "Жарамсыз мән, жарамды диапазон {}-{}"),
        ("Write a message", "Хабарландысы жаз"),
        ("Prompt", ""),
