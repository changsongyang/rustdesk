...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Interval zisťovania (sekundy)"),
        ("Discovery timeout (seconds)", "Časový limit zisťovania (sekundy)"),
        ("Invalid value, valid range is {}-{}", "Neplatná hodnota, platný rozsah je {}-{}"),
