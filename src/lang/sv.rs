...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Upptäckt intervall (sekunder)"),
        ("Discovery timeout (seconds)", "Upptäckt timeout (sekunder)"),
        ("Invalid value, valid range is {}-{}", "Ogiltig värde, giltigt intervall är {}-{}"),
