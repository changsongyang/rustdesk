...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Keşif Aralığı (saniye)"),
        ("Discovery timeout (seconds)", "Keşif Zaman Aşımı (saniye)"),
        ("Invalid value, valid range is {}-{}", "Geçersiz değer, geçerli aralık {}-{}"),
