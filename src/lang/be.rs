...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Інтэрвал выяўлення (секунды)"),
        ("Discovery timeout (seconds)", "Таймаут выяўлення (секунды)"),
        ("Invalid value, valid range is {}-{}", "Недзяснасць значэння, дапушчальны діапазон: {}-{}"),
