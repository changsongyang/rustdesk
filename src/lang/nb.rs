...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Oppdagelsesintervall (sekunder)"),
        ("Discovery timeout (seconds)", "Oppdagelsestid (sekunder)"),
        ("Invalid value, valid range is {}-{}", "Ugyldig verdi, gyldig intervall er {}-{}"),
