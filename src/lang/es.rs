...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Intervalo de descubrimiento (segundos)"),
        ("Discovery timeout (seconds)", "Tiempo de espera de descubrimiento (segundos)"),
        ("Invalid value, valid range is {}-{}", "Valor inválido, el rango válido es {}-{}"),
