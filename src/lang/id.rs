...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Interval Pencarian (detik)"),
        ("Discovery timeout (seconds)", "Batas Waktu Pencarian (detik)"),
        ("Invalid value, valid range is {}-{}", "Nilai tidak valid, rentang valid adalah {}-{}"),
