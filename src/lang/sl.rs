...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Interval odkrivanja (sekunde)"),
        ("Discovery timeout (seconds)", "Časovna omejitev odkrivanja (sekunde)"),
        ("Invalid value, valid range is {}-{}", "Neveljavna vrednost, veljaven interval je {}-{}"),
