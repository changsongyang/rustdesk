...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Opgørelsesinterval (sekunder)"),
        ("Discovery timeout (seconds)", "Tidsgrænse for opdagelse (sekunder)"),
        ("Invalid value, valid range is {}-{}", "Ugyldig værdi, gyldigt interval er {}-{}"),
