...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Interval otkrivanja (sekunde)"),
        ("Discovery timeout (seconds)", "Timeout otkrivanja (sekunde)"),
        ("Invalid value, valid range is {}-{}", "Neispravna vrijednost, valjani raspon je {}-{}"),
