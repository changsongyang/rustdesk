...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Интервал на откриване (секунди)"),
        ("Discovery timeout (seconds)", "Време на изчакване за откриване (секунди)"),
        ("Invalid value, valid range is {}-{}", "Невалидна стойност, валидния диапазон е {}-{}"),
