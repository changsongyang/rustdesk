...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Διάστημα εντοπισμού (δευτερόλεπτα)"),
        ("Discovery timeout (seconds)", "Χρονικό όριο εντοπισμού (δευτερόλεπτα)"),
        ("Invalid value, valid range is {}-{}", "Μη έγκυρη τιμή, ο έγκυρος εύρος είναι {}-{}"),
