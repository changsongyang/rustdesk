...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Enable LAN discovery", "Ebligi LAN-tekton"),
        ("Deny LAN discovery", "Malpermesi LAN-tekton"),
        ("Discovery interval (seconds)", "Tekta intervalo (sekundoj)"),
        ("Discovery timeout (seconds)", "Tekta tempo limito (sekundoj)"),
        ("Invalid value, valid range is {}-{}", "Nevalida valoro, valida intervalo estas {}-{}"),
