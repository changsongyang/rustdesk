...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Ezagutza tarte (segundoak)"),
        ("Discovery timeout (seconds)", "Ezagutza denbora-mugak (segundoak)"),
        ("Invalid value, valid range is {}-{}", "Balio baliogabea, balio-barrera baliagarria {}-{} da"),
