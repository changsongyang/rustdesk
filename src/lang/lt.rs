...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Aptikimo intervalas (sekundės)"),
        ("Discovery timeout (seconds)", "Aptikimo laikas (sekundės)"),
        ("Invalid value, valid range is {}-{}", "Neteisinga reikšmė, galiojantis diapazonas {}-{}"),
