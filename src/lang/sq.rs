...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Intervali i zbulimit (sekonda)"),
        ("Discovery timeout (seconds)", "Koha e kaluar e zbulimit (sekonda)"),
        ("Invalid value, valid range is {}-{}", "Vlera e pavlefshme, intervali i vlefshëm është {}-{}"),
