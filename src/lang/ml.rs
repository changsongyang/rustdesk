...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "കണ്ടെത്തൽ ഇടവേള (സെക്കൻഡ്)"),
        ("Discovery timeout (seconds)", "കണ്ടെത്തൽ ടൈമ്പൗട്ട് (സെക്കൻഡ്)"),
        ("Invalid value, valid range is {}-{}", "അസാധുവായ മൂല്യം, സാധുവായ ശ്രേണി {}-{}"),
