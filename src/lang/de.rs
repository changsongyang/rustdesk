...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Erkennungsintervall (Sekunden)"),
        ("Discovery timeout (seconds)", "Erkennungs-Timeout (Sekunden)"),
        ("Invalid value, valid range is {}-{}", "Ungültiger Wert, gültiger Bereich ist {}-{}"),
