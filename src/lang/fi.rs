...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Havaitseminen väli (sekuntia)"),
        ("Discovery timeout (seconds)", "Havaitseminen aikakatkaisu (sekuntia)"),
        ("Invalid value, valid range is {}-{}", "Kelvoton arvo, kelvollinen väli on {}-{}"),
