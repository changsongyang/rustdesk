...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Intervallu de rilevamentu (segundos)"),
        ("Discovery timeout (seconds)", "Tempu de scadenza de rilevamentu (segundos)"),
        ("Invalid value, valid range is {}-{}", "Valore non validu, intervallu validu est {}-{}"),
