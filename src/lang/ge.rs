...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "აღმოჩენის ინტერვალი (წამები)"),
        ("Discovery timeout (seconds)", "აღმოჩენის დროის ლიმიტი (წამები)"),
        ("Invalid value, valid range is {}-{}", "არასწორი მნიშვნელობა, სწორი დიაპაზონია {}-{}"),
