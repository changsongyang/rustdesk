...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Interwał wykrywania (sekundy)"),
        ("Discovery timeout (seconds)", "Limit czasu wykrywania (sekundy)"),
        ("Invalid value, valid range is {}-{}", "Nieprawidłowa wartość, prawidłowy zakres {}-{}"),
