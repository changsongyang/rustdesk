...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Detectie-interval (seconden)"),
        ("Discovery timeout (seconds)", "Detectietijd (seconden)"),
        ("Invalid value, valid range is {}-{}", "Ongeldige waarde, geldige bereik is {}-{}"),
