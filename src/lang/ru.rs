...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Интервал обнаружения (секунды)"),
        ("Discovery timeout (seconds)", "Тайм-аут обнаружения (секунды)"),
        ("Invalid value, valid range is {}-{}", "Недопустимое значение, допустимый диапазон: {}-{}"),
