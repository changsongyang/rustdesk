...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Enable LAN discovery", "Ativar deteção LAN"),
        ("Deny LAN discovery", "Negar deteção LAN"),
        ("Discovery interval (seconds)", "Intervalo de deteção (segundos)"),
        ("Discovery timeout (seconds)", "Tempo limite de deteção (segundos)"),
        ("Invalid value, valid range is {}-{}", "Valor inválido, intervalo válido é {}-{}"),
