...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovery interval (seconds)", "Interval de descobriment (segons)"),
        ("Discovery timeout (seconds)", "Temps d'espera per al descobriment (segons)"),
        ("Invalid value, valid range is {}-{}", "Valor no vàlid, l'interval vàlid és {}-{}"),
